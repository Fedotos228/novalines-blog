...
export default function Footer() {
		...
		<footer className='mt-12'>
			<div className='bg-foreground flex flex-col gap-12 md:gap-0 md:flex-row items-center justify-evenly text-white py-16'>
				<div className='text-center'>
					<h2>Call</h2>
					<Link
						href='tel:+373 22 85 85 85'
						className='text-muted mt-2 text-sm lg:text-base'
					>
						+373 22 85 85 85
					</Link>
				</div>
				...
				<div className='text-center'>
					<h2>Visit</h2>
					<Link
						href='https://maps.app.goo.gl/HyvwkPGZSW75mVy98'
						className='text-muted mt-2 text-sm lg:text-base'
					>
 ...
 justify-evenly text-muted mt-2 text-sm lg:text-base'
			...
			<Map />
			<div
				className={`${onest.className} flex items-center justify-center flex-wrap gap-5 sm:gap-20 bg-[#202020] py-7 px-4`}
			>
				...
				<p className='text-white'>
					...
					<a
						href='https://www.linkedin.com/company/stellar-solutions-md/'
						className='transition-colors hover:text-blaze-500'
					>
						Stellar Solutions
					</a>
				</p>
